...
test('essay section shows caregiver-resident photo, testimonial shows kriss-homepage-new photo', async ({ page }) => {
  await page.goto('/');
  ...
  await expect(essayImg).toHaveAttribute('src', /caregiver-resident\.png/);
