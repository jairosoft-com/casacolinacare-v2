...
// Test Case 208920 - "A letter from our home" essay section shows updated kriss-homepage-new2 photo
test('essay section shows updated kriss-homepage-new2 photo, not caregiver-resident', async ({ page }) => {
  await page.goto('/');
