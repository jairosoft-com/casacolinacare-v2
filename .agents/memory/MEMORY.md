...
- [Project — Casa Colina Care v2](project-casa-colina.md) — React/Next.js 16 marketing site for a Hawaiʻi Kai care home; design-to-code from Claude Design hi-fi
- [Feedback — Turbopack CSS stale cache](feedback-turbopack-css-stale.md) — Turbopack does not hot-reload a CSS file until it is touched after the dev server starts
